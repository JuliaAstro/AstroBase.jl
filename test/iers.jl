@testset "IERS" begin
    ...
    r = [8.59072560e+02, -4.13720368e+03, 5.29556871e+03]km
    v = [7.37289205e+00, 2.08223573e+00, 4.39999794e-01]kps
    ...
    r_cirf = [852.1380066867667, -4137.052915716736, 5296.806764985966]km
    v_cirf = [7.372309565810324, 2.08224861625441, 0.4495940103957848]kps
    ...
    r_tirf = [1155.6798454967793, -4062.7269296118056, 5296.806764985964]km
    v_tirf = [6.901921544550409, 2.537349749040834, 0.44959401039578467]kps
    ...
    r_itrf = [1155.6809350526369, -4062.7361857684173, 5296.799427643569]km
    v_itrf = [6.9019216369452225, 2.537348963579269, 0.4495970248578132]kps
