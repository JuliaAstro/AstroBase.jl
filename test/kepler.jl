@testset "Kepler" begin
    ...
    μ = 3.986004418e5kg^3/s^2
    r₀exp = [1131.340, -2282.343, 6672.423]km
    v₀exp = [-5.64305, 4.30333, 2.42879]kps
    Δt = 40*60seconds
    r₁exp = [-4219.7527, 4363.0292, -3958.7666]km
    v₁exp = [3.689866, -1.916735, -6.112511]kps
    r₁, v₁ = kepler(μ, r₀exp, v₀exp, Δt)
    @test isapprox(r₁, r₁exp, rtol=1e-4)
    @test isapprox(v₁, v₁exp, rtol=1e-5)
    r₀, v₀ = kepler(μ, r₁, v₁, -Δt)
