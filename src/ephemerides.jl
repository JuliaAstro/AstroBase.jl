using AstroBase: AbstractEphemeris
using OptionalData
...
@OptionalData EPHEMERIS AbstractEphemeris
...
function load_ephemeris!(eph::E) where E<:AbstractEphemeris
    push!(EPHEMERIS, eph)
end

function load_ephemeris!(::Type{E}, file) where E<:AbstractEphemeris
