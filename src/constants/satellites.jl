...
α₀(::Type{Moon}) = rad(269.9949°)
α₁(::Type{Moon}) = rad(0.0031°)
δ₀(::Type{Moon}) = rad(66.5392°)
δ₁(::Type{Moon}) = rad(0.0130°)
w₀(::Type{Moon}) = rad(38.3213°)
w₁(::Type{Moon}) = rad(13.17635815°)
w₂(::Type{Moon}) = rad(-1.4e-12°)
α(::Type{Moon}) = rad.([-3.8787, -0.1204, 0.07, -0.0172, 0.0, 0.0072, 0.0, 0.0,
    0.0, -0.0052, 0.0, 0.0, 0.0043]°)
δ(::Type{Moon}) = rad.([1.5419, 0.0239, -0.0278, 0.0068, 0.0, -0.0029, 0.0009,
    0.0, 0.0, 0.0008, 0.0, 0.0, -0.0009]°)
w(::Type{Moon}) = rad.([3.5610, 0.1208, -0.0642, 0.0158, 0.0252, -0.0066,
    -0.0047, -0.0046, 0.0028, 0.0052, 0.004, 0.0019, -0.0044]°)
θ₀(::Type{Moon}) = rad.([125.045, 250.089, 260.008, 176.625, 357.529, 311.589,
    134.963, 276.617, 34.226, 15.134, 119.743, 239.961, 25.053]°)
θ₁(::Type{Moon}) = rad.([-0.0529921, -0.1059842, 13.0120009, 13.3407154,
