...
α₀(::Type{Mercury}) = rad(281.0097°)
α₁(::Type{Mercury}) = rad(-0.0328°)
δ₀(::Type{Mercury}) = rad(61.41430°)
δ₁(::Type{Mercury}) = rad(-0.0049°)
w₀(::Type{Mercury}) = rad(329.5469°)
w₁(::Type{Mercury}) = rad(6.1385025°)
w(::Type{Mercury}) = rad.([0.00993822, -0.00104581, -0.00010280, -0.00002364,
    -0.00000532]°)
θ₀(::Type{Mercury}) = rad.([174.791086, 349.582171, 164.373257, 339.164343,
    153.955429]°)
θ₁(::Type{Mercury}) = rad.([4.092335, 8.184670, 12.277005, 16.369340,
    20.461675]°)*36525.0
...
α₀(::Type{Venus}) = rad(272.76°)
δ₀(::Type{Venus}) = rad(67.16°)
w₀(::Type{Venus}) = rad(160.20°)
w₁(::Type{Venus}) = rad(-1.4813688°)
...
α₁(::Type{Earth}) = rad(-0.641°)
δ₀(::Type{Earth}) = rad(90°)
δ₁(::Type{Earth}) = rad(-0.557°)
w₀(::Type{Earth}) = rad(190.147°)
w₁(::Type{Earth}) = rad(360.9856235°)
...
α₀(::Type{Mars}) = rad(317.68143°)
α₁(::Type{Mars}) = rad(-0.1061°)
δ₀(::Type{Mars}) = rad(52.886500°)
δ₁(::Type{Mars}) = rad(-0.0609°)
w₀(::Type{Mars}) = rad(176.630°)
w₁(::Type{Mars}) = rad(350.89198226°)
...
α₀(::Type{Jupiter}) = rad(268.056595°)
α₁(::Type{Jupiter}) = rad(-0.006499°)
δ₀(::Type{Jupiter}) = rad(64.4953030°)
δ₁(::Type{Jupiter}) = rad(0.002413°)
w₀(::Type{Jupiter}) = rad(284.95°)
w₁(::Type{Jupiter}) = rad(870.536°)
α(::Type{Jupiter}) = rad.([0.000117, 0.000938, 0.001432, 0.00003, 0.002150]°)
δ(::Type{Jupiter}) = rad.([0.00005, 0.000404, 0.000617, -0.000013, 0.000926]°)
θ₀(::Type{Jupiter}) = rad.([99.360714, 175.895369, 300.323162, 114.012305,
    49.511251]°)
θ₁(::Type{Jupiter}) = rad.([4850.4046, 1191.9605, 262.5475, 6070.2476, 64.3]°)
...
α₀(::Type{Saturn}) = rad(40.589°)
α₁(::Type{Saturn}) = rad(-0.036°)
δ₀(::Type{Saturn}) = rad(83.537°)
δ₁(::Type{Saturn}) = rad(-0.004°)
w₀(::Type{Saturn}) = rad(38.90°)
w₁(::Type{Saturn}) = rad(810.7939024°)
...
α₀(::Type{Uranus}) = rad(257.311°)
δ₀(::Type{Uranus}) = rad(-15.1750°)
w₀(::Type{Uranus}) = rad(203.81°)
w₁(::Type{Uranus}) = rad(-501.1600928°)
...
α₀(::Type{Neptune}) = rad(299.36°)
δ₀(::Type{Neptune}) = rad(43.460°)
w₀(::Type{Neptune}) = rad(253.18°)
w₁(::Type{Neptune}) = rad(536.3128492°)
α(::Type{Neptune}) = rad.([0.7]°)
δ(::Type{Neptune}) = rad.([-0.51]°)
w(::Type{Neptune}) = rad.([-0.48]°)
θ₀(::Type{Neptune}) = rad.([357.85]°)
θ₁(::Type{Neptune}) = rad.([52.316]°)
